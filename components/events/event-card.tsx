...
import { MapPin, Briefcase, DollarSign, Clock, Star, TrendingUp, MoreVertical, Bookmark, Share2, Users, Heart, Eye, Calendar } from "lucide-react"
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <Avatar className="h-6 w-6">
                            <AvatarImage src={event.creator.avatar || "/placeholder.svg"} alt={event.creator.name} />
