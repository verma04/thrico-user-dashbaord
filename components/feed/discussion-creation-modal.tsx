...
export function DiscussionCreationModal({ open, onOpenChange, initialData }: DiscussionCreationModalProps) {
          ...
          <div className="space-y-6 pb-6">
            ...
            <div className="p-4 bg-muted/30 rounded-lg">
              ...
              <p className="text-sm text-muted-foreground">
                Start a conversation, ask questions, or share insights with the community.
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-muted-foreground ml-auto">{formData.content.length}/5000</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <Label className="text-base font-medium">Discussion Settings</Label>
              ...
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">Your name and profile will be hidden from other users</p>
                </div>
                <Switch
                  id="anonymous"
              ...
              <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
                ...
                <div className="text-sm">
                  <p className="font-medium text-blue-900">Discussion Visibility</p>
                  <p className="text-blue-700">
                    This discussion will be visible to all community members and can receive replies and reactions.
                  </p>
                </div>
              </div>
            </div>
