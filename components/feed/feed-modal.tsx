...
import { ArrowLeft, X, AlertCircle, Save, Plus } from "lucide-react";
...
import { useAddFeed } from "../grapqhl/action/feed";
...
export function FeedModal({
  ...
  const open = useDrawerStore((s) => s.isFeedDrawerOpen);

  const onOpenChange = useDrawerStore((s) => s.setFeedDrawerOpen);
  ...
  const remainingCharacters = useMemo(
    () => maxDescriptionLength - characterCount,
    [maxDescriptionLength, characterCount]
  );
              ...
              <div className="flex items-center justify-between p-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <Button
                    ...
                    aria-label={
                      isSubmitting ? "Posting content" : "Post content"
                    }
                  >
                    {isSubmitting
                      ? "Posting..."
